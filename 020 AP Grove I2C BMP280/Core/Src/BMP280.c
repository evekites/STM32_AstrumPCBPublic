...
uint8_t I2C_Read_Register(uint8_t device_adr, uint8_t internal_adr)
{
	...
	HAL_I2C_Master_Transmit(&hi2c3, device_adr, &tx_buff[0], 1, 10000);
	HAL_I2C_Master_Receive(&hi2c3, device_adr + 1, &rx_buff[0], 1, 10000);
...
void I2C_Write_Register(uint8_t device_adr, uint8_t internal_adr, uint8_t data)
{
	...
	HAL_I2C_Master_Transmit(&hi2c3, device_adr, tx_buff, 2, 10000);
}
...
void BMP280_get_calib_values(void)
{
	...
	HAL_I2C_Master_Transmit(&hi2c3, BMP280_dev_address, &starting_address, 1, 10000);
	HAL_I2C_Master_Receive(&hi2c3, BMP280_dev_address + 1, &rx_buff[0], 24, 10000);
...
void BMP280_calc_values(void)
{
	...
	HAL_I2C_Master_Transmit(&hi2c3, BMP280_dev_address, &starting_address, 1, 10000);
	HAL_I2C_Master_Receive(&hi2c3, BMP280_dev_address + 1, &rx_buff[0], 6, 10000);
